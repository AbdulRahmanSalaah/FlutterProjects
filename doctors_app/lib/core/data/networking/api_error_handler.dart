...
// // TODOO: wallahy I will refactor this .. Omar Ahmed
// enum DataSource {
//   NO_CONTENT,
//   BAD_REQUEST,
//   FORBIDDEN,
...
//         // Handle specific error codes and user-friendly messages
...
//         // Fallback to generic message if no specific error is found
//         if (responseData != null && responseData['message'] != null) {
//           return ApiErrorModel(
//             code: error.response!.statusCode!,
//             message: responseData['message'], // Use the API message if available
//           );
//         } else {
